...
- [value.us](https://value.us/mcp) 🌐 — Verified retail intelligence (deals, store policies & a VUS data-confidence score) for thousands of online retailers. Read-only, no auth.
